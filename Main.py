...
# GRAPHICAL SHOW
                ...
                for cur50 in sorted(sponsors):
                    ...
                    if u == 1:
                        nx.draw_networkx_nodes(G, pos, node_size=cur50.s_range * 300, nodelist=[cur50.ID], node_color='black',alpha=0.2)
                    if u == 2:
                        nx.draw_networkx_nodes(G, pos, node_size=cur50.s_range * 300, nodelist=[cur50.ID], node_color='b',alpha=0.2)
                    if u == 3:
                        nx.draw_networkx_nodes(G, pos, node_size=cur50.s_range * 300, nodelist=[cur50.ID], node_color='r',alpha=0.2)
                    if u == 4:
                        nx.draw_networkx_nodes(G, pos, node_size=cur50.s_range * 300, nodelist=[cur50.ID], node_color='green',alpha=0.2)
                u=0
                m=0
                for cur11 in sorted(sponsors):
                    m+=1
